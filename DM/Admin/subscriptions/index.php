...
<div class="admin-wrapper">
  ...
  <ul>
    ...
    <li><a href="index.php">Manage Subscription </a></li>
...
<a href="create.php" class="btn btn-big btn-primary">Send Letter To all</a>
<!-- <a href="index.php" class="btn btn-big btn-primary">Manage post</a>
 --> </div>
 <div class="content">
   
   <h2 class="page-title">Manage Subscription</h2>
...
$select_query = "SELECT * FROM `newsletter` WHERE 1";
...
<td>$name</td>
<td>$mail</td>
<td><a href='#' class='btn btn-outline-primary btn-block' >SEND NEWS</a></td>
<td><a href='#' class='btn btn-outline-danger btn-block' >DECLINE</a></td>
</tr>";
}
?>
   </table>
